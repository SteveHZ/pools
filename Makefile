# This Makefile is for the Pools extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[Pools]
#     EXE_FILES => [q[script/pools_cgi.pl], q[script/pools_create.pl], q[script/pools_fastcgi.pl], q[script/pools_server.pl], q[script/pools_test.pl]]
#     LICENSE => q[perl]
#     NAME => q[Pools]
#     NO_META => q[1]
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/pools_cgi.pl \
	script/pools_create.pl \
	script/pools_fastcgi.pl \
	script/pools_server.pl \
	script/pools_test.pl
MAN3PODS = lib/Pools.pm \
	lib/Pools/Controller/Root.pm
...
TO_INST_PM = lib/Pools.pm \
	lib/Pools/Controller/Root.pm

PM_TO_BLIB = lib/Pools.pm \
	blib\lib\Pools.pm \
	lib/Pools/Controller/Root.pm \
	blib\lib\Pools\Controller\Root.pm
...
Pools.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Pools\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) -u \
	  script/pools_cgi.pl $(INST_MAN1DIR)\pools_cgi.pl.$(MAN1EXT) \
	  script/pools_create.pl $(INST_MAN1DIR)\pools_create.pl.$(MAN1EXT) \
	  script/pools_fastcgi.pl $(INST_MAN1DIR)\pools_fastcgi.pl.$(MAN1EXT) \
	  script/pools_server.pl $(INST_MAN1DIR)\pools_server.pl.$(MAN1EXT) \
	  script/pools_test.pl $(INST_MAN1DIR)\pools_test.pl.$(MAN1EXT) 
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Pools.pm $(INST_MAN3DIR)\Pools.$(MAN3EXT) \
	  lib/Pools/Controller/Root.pm $(INST_MAN3DIR)\Pools.Controller.Root.$(MAN3EXT) 
...
EXE_FILES = script/pools_cgi.pl script/pools_create.pl script/pools_fastcgi.pl script/pools_server.pl script/pools_test.pl

pure_all :: $(INST_SCRIPT)\pools_server.pl $(INST_SCRIPT)\pools_fastcgi.pl $(INST_SCRIPT)\pools_create.pl $(INST_SCRIPT)\pools_test.pl $(INST_SCRIPT)\pools_cgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)\pools_server.pl $(INST_SCRIPT)\pools_fastcgi.pl \
	  $(INST_SCRIPT)\pools_create.pl $(INST_SCRIPT)\pools_test.pl \
	  $(INST_SCRIPT)\pools_cgi.pl 

$(INST_SCRIPT)\pools_server.pl : script/pools_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\pools_server.pl
	$(CP) script/pools_server.pl $(INST_SCRIPT)\pools_server.pl
	$(FIXIN) $(INST_SCRIPT)\pools_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\pools_server.pl

$(INST_SCRIPT)\pools_fastcgi.pl : script/pools_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\pools_fastcgi.pl
	$(CP) script/pools_fastcgi.pl $(INST_SCRIPT)\pools_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)\pools_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\pools_fastcgi.pl

$(INST_SCRIPT)\pools_create.pl : script/pools_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\pools_create.pl
	$(CP) script/pools_create.pl $(INST_SCRIPT)\pools_create.pl
	$(FIXIN) $(INST_SCRIPT)\pools_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\pools_create.pl

$(INST_SCRIPT)\pools_test.pl : script/pools_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\pools_test.pl
	$(CP) script/pools_test.pl $(INST_SCRIPT)\pools_test.pl
	$(FIXIN) $(INST_SCRIPT)\pools_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\pools_test.pl

$(INST_SCRIPT)\pools_cgi.pl : script/pools_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\pools_cgi.pl
	$(CP) script/pools_cgi.pl $(INST_SCRIPT)\pools_cgi.pl
	$(FIXIN) $(INST_SCRIPT)\pools_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\pools_cgi.pl
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Pools.pm blib\lib\Pools.pm \
	  lib/Pools/Controller/Root.pm blib\lib\Pools\Controller\Root.pm 
